...
import { engineJson, getEvaluation, getTechnical, getMe } from "@/lib/engine";
...
export default async function ScorePage({
  ...
  const [det, tech, me, scr] = await Promise.all([
    ...
    getTechnical(id),
    getMe(),
    engineJson<Screening>(`/api/evaluations/${id}/screening`),
  ]);
  ...
  const locked = !!det.data.evaluation.technical_locked_at;
