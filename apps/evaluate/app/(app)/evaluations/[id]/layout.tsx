...
import { EvaluationTabs, type Tab } from "@/components/design/EvaluationTabs";
...
export default async function EvaluationLayout({
  ...
  const { evaluation: ev, bids, members, coi, unconfirmed } = det.data;
